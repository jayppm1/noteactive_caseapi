...
class Modelsettingtags extends Model {
	...
	if(in_array('person_screening',$hidden_fields)) {
		...
		*/
		...
		$sql1 = "CALL insertTags('".$this->db->escape($data['emp_tag_id'])."','".$this->db->escape($data['emp_first_name'])."','" . $this->db->escape($data['emp_middle_name']) . "','".$this->db->escape($data['emp_last_name'])."','".$this->db->escape($data['privacy'])."','".(int)$data['sort_order']."','".$this->db->escape($data['doctor_name'])."','".$this->db->escape($data['emergency_contact'])."','".$dob."','".$this->db->escape($data['medication'])."','".$this->db->escape($data['locations_id'])."','".$facilities_id."','".$this->db->escape($data['upload_file'])."','".$this->db->escape($data['tags_pin'])."','". $this->db->escape($gender)."','".$age."','".$date_added."','".$this->db->escape($data['emp_extid'])."','".$this->db->escape($data['address_street2'])."','".$this->db->escape($data['person_screening'])."','".$this->db->escape($date_of_screening)."','".$this->db->escape($data['ssn'])."','".$this->db->escape($data['state'])."','".$this->db->escape($data['city'])."','".$this->db->escape($data['zipcode'])."','".$this->db->escape($address)."','".$this->db->escape($latitude2)."','".$this->db->escape($longitude2) ."','".$this->db->escape($room) ."','".$this->db->escape($data['restriction_notes']) ."','".$this->db->escape($data['prescription']) ."','".$this->db->escape($data['alert_info']) ."','".$this->db->escape($data['constant_sight']) ."','".$this->db->escape($data['med_mental_health']) ."','".$this->db->escape($data['tagstatus']) ."','".$this->db->escape($data['gender']) ."','".$this->db->escape($data['tags_status_in']) ."'
		,'".$this->db->escape($data['referred_facility']) ."','".$reminder_date ."','".$reminder_time ."','".$this->db->escape($data['phone_device_id'])."','".$this->db->escape($data['is_android'])."','".$this->db->escape($date_added)."','".$this->db->escape($unique_id)."' )";
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "tags` SET customer_key = '" . $customer_info['activecustomer_id'] . "', modify_date = '" . $date_added . "' WHERE tags_id = '" . (int)$tags_id . "'");
	...
	public function editTags($tags_id, $data, $facilities_id) {
		...
		if(strpos($data['address_street2'], '*') === false){
			...
			$data['address_street2'] = $mrow['address_street2'];
		}
		if(strpos($data['person_screening'], '*') === false){
			...
			$data['person_screening'] = $mrow['person_screening'];
		}
		...
		if(strpos($data['restriction_notes'], '*') === false){
			...
			$data['restriction_notes'] = $mrow['restriction_notes'];
		}
		if(strpos($data['alert_info'], '*') === false){
			...
			$data['alert_info'] = $mrow['alert_info'];
		}
		if(strpos($data['constant_sight'], '*') === false){
			...
			$data['constant_sight'] = $mrow['constant_sight'];
		}
		if(strpos($data['med_mental_health'], '*') === false){
			...
			$data['med_mental_health'] = $mrow['med_mental_health'];
		}
		...
		if(strpos($data['prescription'], '*') === false){
			...
			$data['prescription'] = $mrow['prescription'];
		}
		
		if($data['emp_first_name'] != null && $data['emp_first_name'] != ""){
			$sql = "UPDATE `" . DB_PREFIX . "tags` SET emp_first_name = '" . $data['emp_first_name'] . "', emp_last_name = '" . $data['emp_last_name'] . "', status = '1', role_call = '1', modify_date = '".$date_added."', facilities_id = '" . $facilities_id . "',emp_middle_name = '" . $this->db->escape($data['emp_middle_name']) . "'  WHERE tags_id = '" . (int)$tags_id . "'";
			$this->db->query($sql);
		}
	...
	public function updateclientsign($data, $data2){
			...
			if($data2['tags_status_in_change'] == '2'){
				...
				$data['notes_description'] = $tag_info['emp_tag_id'].':'.$tag_info['emp_first_name'] .' updated '.$comments;
			}
	...
	public function getTags($data = array()) {
		...
		if($data['tags_exits'] == "1"){
			if($data['exits_emp_extid'] != null && $data['exits_emp_extid'] != ""){
				$sql.= " and emp_extid = '".$data['exits_emp_extid']."'";
			}
			
			if($data['exits_ssn'] != null && $data['exits_ssn'] != ""){
				$sql.= " and ssn = '".$data['exits_ssn']."'";
			}
			
			if(($data['exits_ssn'] != null && $data['exits_ssn'] != "") || ($data['exits_emp_extid'] != null && $data['exits_emp_extid'] != "")){
				$sql .= " or ( LOWER(emp_first_name) LIKE '%".strtolower($data['exits_emp_first_name'])."%' and LOWER(emp_last_name) LIKE '%".strtolower($data['exits_emp_last_name'])."%' ) ";
			}else if($data['exits_emp_first_name'] != null && $data['exits_emp_first_name'] != ""){
				$sql .= " and ( LOWER(emp_first_name) LIKE '%".strtolower($data['exits_emp_first_name'])."%' and LOWER(emp_last_name) LIKE '%".strtolower($data['exits_emp_last_name'])."%' ) ";
			}
	...
	public function getTagsbyName($emp_first_name, $emp_last_name) {
		$sql = "SELECT tags_id,emp_tag_id,emp_first_name,emp_middle_name,emp_last_name,privacy,date_added,dob,locations_id,facilities_id,upload_file,tags_pin,gender,discharge,age,role_call,location_address,latitude,longitude,emp_extid,address_street2,person_screening,date_of_screening,ssn,state,city,zipcode,room,restriction_notes,prescription,alert_info,constant_sight,med_mental_health,tagstatus,forms_id,tags_forms_id,discharge_date,stickynote,customlistvalues_id,tags_status,tags_status_in,referred_facility,emergency_contact,reminder_time,reminder_date,upload_file_thumb FROM `" . DB_PREFIX . "tags` WHERE LCASE(emp_first_name) = '" . $this->db->escape(utf8_strtolower($emp_first_name)) . "' and LCASE(emp_last_name) = '" . $this->db->escape(utf8_strtolower($emp_last_name)) . "' and discharge = '0' ";
		$query = $this->db->query($sql);
		$result = $query->row;
		$keys = array_keys($result);
		foreach($keys as $key) {
	...
	public function getTagsbySSN($ssn) {
		$sql = "SELECT tags_id,emp_tag_id,emp_first_name,emp_middle_name,emp_last_name,privacy,date_added,dob,locations_id,facilities_id,upload_file,tags_pin,gender,discharge,age,role_call,location_address,latitude,longitude,emp_extid,address_street2,person_screening,date_of_screening,ssn,state,city,zipcode,room,restriction_notes,prescription,alert_info,constant_sight,med_mental_health,tagstatus,forms_id,tags_forms_id,discharge_date,stickynote,customlistvalues_id,tags_status,tags_status_in,referred_facility,emergency_contact,reminder_time,reminder_date,upload_file_thumb FROM `" . DB_PREFIX . "tags` WHERE LCASE(ssn) = '" . $this->db->escape(utf8_strtolower($ssn)) . "' and discharge = '0' ";
		$query = $this->db->query($sql);
		$result = $query->row;
		$keys = array_keys($result);
		foreach($keys as $key) {
	...
	public function getTagsbyextID($emp_extid) {
		$sql = "SELECT tags_id,emp_tag_id,emp_first_name,emp_middle_name,emp_last_name,privacy,date_added,dob,locations_id,facilities_id,upload_file,tags_pin,gender,discharge,age,role_call,location_address,latitude,longitude,emp_extid,address_street2,person_screening,date_of_screening,ssn,state,city,zipcode,room,restriction_notes,prescription,alert_info,constant_sight,med_mental_health,tagstatus,forms_id,tags_forms_id,discharge_date,stickynote,customlistvalues_id,tags_status,tags_status_in,referred_facility,emergency_contact,reminder_time,reminder_date,upload_file_thumb FROM `" . DB_PREFIX . "tags` WHERE LCASE(emp_extid) = '" . $this->db->escape(utf8_strtolower($emp_extid)) . "' and discharge = '0'  ";
		$query = $this->db->query($sql);
		$result = $query->row;
		$keys = array_keys($result);
		foreach($keys as $key) {
	...
	public function getTagsbyDOBName($dob, $emp_first_name, $emp_last_name) {
		$sql = "SELECT tags_id,emp_tag_id,emp_first_name,emp_middle_name,emp_last_name,privacy,date_added,dob,locations_id,facilities_id,upload_file,tags_pin,gender,discharge,age,role_call,location_address,latitude,longitude,emp_extid,address_street2,person_screening,date_of_screening,ssn,state,city,zipcode,room,restriction_notes,prescription,alert_info,constant_sight,med_mental_health,tagstatus,forms_id,tags_forms_id,discharge_date,stickynote,customlistvalues_id,tags_status,tags_status_in,referred_facility,emergency_contact,reminder_time,reminder_date,upload_file_thumb FROM `" . DB_PREFIX . "tags` WHERE LCASE(emp_first_name) = '" . $this->db->escape(utf8_strtolower($emp_first_name)) . "' and LCASE(emp_last_name) = '" . $this->db->escape(utf8_strtolower($emp_last_name)) . "' and dob = '".$this->db->escape($dob)."' and discharge = '0' ";
		$query = $this->db->query($sql);
		$result = $query->row;
		$keys = array_keys($result);
		foreach($keys as $key) {
	...
	public function updatexittag($data, $facilities_id){
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "tags` SET discharge = '0', role_call = '1', date_added = '" . $this->db->escape($date_added) . "', facilities_id = '" . $this->db->escape($facilities_id) . "' WHERE tags_id = '" . $this->db->escape($data['emp_tag_id']) . "'");
	...
	public function gettagscustomlistvaluebyid($room, $role_call, $facilities_id) {
		$sql = "SELECT tags_id,emp_tag_id,emp_first_name,emp_middle_name,emp_last_name,privacy,date_added,dob,locations_id,facilities_id,upload_file,tags_pin,gender,discharge,age,role_call,location_address,latitude,longitude,emp_extid,address_street2,person_screening,date_of_screening,ssn,state,city,zipcode,room,restriction_notes,prescription,alert_info,constant_sight,med_mental_health,tagstatus,forms_id,tags_forms_id,discharge_date,stickynote,customlistvalues_id,tags_status,tags_status_in,referred_facility,emergency_contact,reminder_time,reminder_date,upload_file_thumb FROM " . DB_PREFIX . "tags WHERE room = '" . $room . "' and facilities_id = '" . $facilities_id . "' and role_call = '".$role_call."' and discharge = '0' and tags_status_in = 'Admitted' ";

...
class Modelcreatetaskcreatetask extends Model {
	...
	public function addcreatetask($data, $facilities_id) {
		...
		$endtime1 = explode ( ":", $endtime );
		
		if ($endtime1 [0] == "00") {
			// $endtime2 = '12:'.$endtime1[1];
			$time1 = $endtime;
			
			$dateRange12 = date ( "Y-m-d", strtotime ( date ( "Y-m-d", strtotime ( $dateRange1 ) ) . " + 1 day" ) );
		} else {
			$time1 = date ( 'H:i:s' );
			$dateRange12 = $dateRange1;
		}
		
		$end_recurrence_date = $dateRange12 . ' ' . $time1;
		$end_recurrence_date1 = $dateRange12 . ' ' . $time1;
		// }
		// }
		...
		$bed_check_facilities_ids = implode ( ',', $data ['bed_check_facilities_ids'] );
		...
		if (trim ( $data ['description'] ) != null && trim ( $data ['description'] ) != "") {
			...
			if ($data ['required_approval'] == '1') {
				...
				$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',assign_to = '" . $assign_to . "',user_role_assign_ids = '" . $user_role_assign_ids . "',emp_tag_id = '" . ( int ) $data ['emp_tag_id'] . "',tags_id = '" . ( int ) $data ['tags_id'] . "' WHERE id = '" . ( int ) $approval_taskid . "' ";
			...
			switch ($data ['recurrence']) {
				case "hourly" :
					...
					if ($data ['recurnce_hrly_recurnce'] == "Daily" && empty ( $data ['weekly_interval'] )) {
						...
						$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',formreturn_id = '" . $data ['formreturn_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',assign_to = '" . $assign_to . "',assign_to_type = '" . $data ['assign_to_type'] . "',bed_check_facilities_ids = '" . $bed_check_facilities_ids. "',reminder_alert = '" . $data ['reminder_alert'] . "',form_task_creation = '" . $data ['form_task_creation'] . "',bedcheck_occupancy = '" . $data ['bedcheck_occupancy'] . "',required_assign = '" . $data ['required_assign'] . "' WHERE id = '" . ( int ) $task_id . "' ";
						$this->db->query ( $sql12 );
						...
						if(($data['recurnce_hrly_recurnce']!="" && $data['recurnce_hrly_recurnce']!=null) && (!empty ($data['weekly_interval'])) && $data['original_task_time']==''){
						
							$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET original_task_time = '" . $taskTime . "' WHERE id = '" . ( int ) $task_id . "' ";
							$this->db->query ( $sql12 ); 
							
						}	
						
						$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',formreturn_id = '" . $data ['formreturn_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',assign_to = '" . $assign_to . "',assign_to_type = '" . $data ['assign_to_type'] . "',bed_check_facilities_ids = '" . $bed_check_facilities_ids. "',form_task_creation = '" . $data ['form_task_creation'] . "',reminder_alert = '" . $data ['reminder_alert'] . "',bedcheck_occupancy = '" . $data ['bedcheck_occupancy'] . "',required_assign = '" . $data ['required_assign'] . "' WHERE id = '" . ( int ) $task_id . "' ";
						$this->db->query ( $sql12 );
						...
						foreach ( $data ['daily_times'] as $dailytime ) {
							...
							if ($data ['medication_tags']) {
								/*foreach ( $data ['medication_tags'] as $medication_tag ) {*/
									foreach ( $data ['tags_medication_details_ids'] as $medication_tag => $tags_medication_details_ids ) {
					...
					if ($data ['recurrence'] == "monthly") {
						...
						if ($data ['medication_tags']) {
							...
							'" . $this->db->escape ( $unique_id ) . "' ,'" . $this->db->escape ( $activecustomer_id ) . "'
								...
								$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',formreturn_id = '" . $data ['formreturn_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',form_task_creation = '" . $data ['form_task_creation'] . "',assign_to = '" . $assign_to . "',assign_to_type = '" . $data ['assign_to_type'] . "',bed_check_facilities_ids = '" . $bed_check_facilities_ids. "',reminder_alert = '" . $data ['reminder_alert'] . "',bedcheck_occupancy = '" . $data ['bedcheck_occupancy'] . "',required_assign = '" . $data ['required_assign'] . "' WHERE id = '" . ( int ) $task_id . "' ";
								$this->db->query ( $sql12 );
				...
				case "yearly" :
					...
					if ($data ['medication_tags']) {
						/*foreach ( $data ['medication_tags'] as $medication_tag ) {*/
							...
							'" . $this->db->escape ( $durationv ) . "',
							'" . $this->db->escape ( $data ['iswaypoint'] ) . "',							
							 '" . $this->db->escape ( $bed_check_facilities_ids ) . "',
							'" . $this->db->escape ( $data ['complete_status'] ) . "',
							'" . $this->db->escape ( $weekly_interval ) . "',
							'" . $this->db->escape ( $data ['phone_device_id'] ) . "',
							'" . $this->db->escape ( $data ['is_android'] ) . "',
				...
				case "Perpetual" :
					...
					if ($data ['medication_tags']) {
						/*foreach ( $data ['medication_tags'] as $medication_tag ) {*/
							...
							$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',formreturn_id = '" . $data ['formreturn_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',bed_check_facilities_ids = '" . $bed_check_facilities_ids. "',form_task_creation = '" . $data ['form_task_creation'] . "',assign_to = '" . $assign_to . "',assign_to_type = '" . $data ['assign_to_type'] . "',reminder_alert = '" . $data ['reminder_alert'] . "',bedcheck_occupancy = '" . $data ['bedcheck_occupancy'] . "',required_assign = '" . $data ['required_assign'] . "' WHERE id = '" . ( int ) $task_id . "' ";
							$this->db->query ( $sql12 );
						...
						$sql12 = "UPDATE `" . DB_PREFIX . "createtask` SET required_approval = '" . $data ['required_approval'] . "',linked_id = '" . $data ['linked_id'] . "',formreturn_id = '" . $data ['formreturn_id'] . "',target_facilities_id = '" . $data ['target_facilities_id'] . "',user_role_assign_ids = '" . $user_role_assign_ids . "',assign_to = '" . $assign_to . "',form_task_creation = '" . $data ['form_task_creation'] . "',assign_to_type = '" . $data ['assign_to_type'] . "',bed_check_facilities_ids = '" . $bed_check_facilities_ids. "',reminder_alert = '" . $data ['reminder_alert'] . "',bedcheck_occupancy = '" . $data ['bedcheck_occupancy'] . "',required_assign = '" . $data ['required_assign'] . "' WHERE id = '" . ( int ) $task_id . "' ";
						$this->db->query ( $sql12 );
	...
	public function getNotification($facilities_id) {
		$sqlquery = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE facilityId = '" . $facilities_id . "'";
	...
	public function getTasklist($facilities_id, $searchdate, $top, $tags_id) {
		...
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE taskadded = '0' and enable_requires_approval !=1  ";
		
		
		if ($facilities_id != "" && $facilities_id != null) {
			$this->load->model ( 'facilities/facilities' );
			$resulsst = $this->model_facilities_facilities->getfacilities ( $facilities_id );
			
			
			if ($resulsst ['task_facilities_ids'] != null && $resulsst ['task_facilities_ids'] != "") {
				$ddss [] = $resulsst ['task_facilities_ids'];
				$ddss [] = $facilities_id;
		...
		if ($tags_id != "" && $tags_id != null) {
			...
			$sql .= " and ( emp_tag_id = '" . $tags_id . "' or medication_tags = '" . $tags_id . "' or visitation_tag_id = '" . $tags_id . "' or FIND_IN_SET('" . $tags_id . "', transport_tags) OR  tags_id = '" . $tags_id . "') ";
			}
	...
	public function gettaskLists($searchdate, $facilities_id) {
		$taskLists = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE taskadded = '0' and enable_requires_approval != '1' and facilityId = '" . $facilities_id . "' ";
	...
	public function getnotesInfo($task_id) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE id = '" . $task_id . "'";
		$query = $this->db->query ( $sql );
		return $query->row;
	}
	...
	public function getStrikedatadetails($task_id) {
		$sql = "SELECT  id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` where id='" . $task_id . "' and taskadded = '0' ";
		$query = $this->db->query ( $sql );
		return $query->row;
	}
	public function insertDatadetails($result, $data, $facilities_id, $requires_approval) {
		...
		if ($data ['new_module']) {
			...
			foreach ($data['new_module'] as $customlistvalues_id) {

				if($customlistvalues_id['checkin']=="1"){

					$customlistvalues_name .= ' | ' . $customlistvalues_id['customlistvalues_name'];
					$ids[] = $customlistvalues_id['customlistvalues_id'];
				}
				
			}
			$customlistids = implode(',', $ids);
			$customlistvalues_id = $customlistids;
			//$customlistvalues_id = $ids;
		...
		if ($user_role_info ['is_add_note'] == '1') {
			$description .= ' ' . $user_role_info ['name'] .' check';
		}
	...
	public function inserttask($result, $data, $facilities_id, $requires_approval) {
		...
		if ($tasktypetype == '5') {
			...
			if ($this->db->escape ( $data ['reassign_id'] ) != NULL && $this->db->escape ( $data ['reassign_id'] ) != "") {
				$this->load->model ( 'user/user' );
				$user_info2 = $this->model_user_user->getUser ( $data ['reassign_id'] );
		
				$description .= ' | SIGHT AND SOUND ASSIGN TO ' . $user_info2 ['username'];
				
				$sql1assign = "UPDATE `" . DB_PREFIX . "createtask` set assign_to = '".$user_info2 ['username']."' where id = '" . $result ['id'] . "' ";
				$this->db->query ( $sql1assign );
	...
	public function insertTaskLists($result, $facilities_id, $client_discharge) {
		...
		$facilities_id = $task_info ['facilityId'];
	...
	public function getnotesInfo2($task_id) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE id = '" . $task_id . "'";
		$query = $this->db->query ( $sql );
		return $query->row;
	}
	public function deteteIncomTask($facilities_id) {
		...
		//$sql = "update `" . DB_PREFIX . "createtask` set taskadded = '5' where taskadded != '0' and facilityId = '" . $facilities_id . "' ";
		$this->db->query ($sql);
		
		$this->load->model ( 'activity/activity' );
		$adata ['facilities_id'] = $facilities_id;
		$this->model_activity_activity->addActivitySave ( 'deteteIncomTask', $adata, 'query' );
		...
		if ($data ['end_recurrence_date'] != "0000-00-00 00:00:00") {
			...
			if ($data ['end_perpetual_task'] != '2') {
				...
				if ($days > 0) {
					...
					if ($data ['recurrence'] == 'monthly') {
						...
						if ($data ['recurnce_hrly_recurnce'] == "Daily") {
							...
							if ($data ['weekly_interval'] != null && $data ['weekly_interval'] != "") {
								...
								//$end_recurrence_date1 = date('Y-m-d',strtotime($data ['task_date'])); 
								...
								//var_dump($newtask." ".$newtaskend);die;
								
								$timestamp = strtotime($data['original_task_time']);
								$timestamp1 = strtotime($data['task_time']);		
								...
								if (in_array ( $current_day, $intervalday )) {									
									...
									if($newtask < $newtaskend){	                                 									
                                       ...
                                       if($data ['endtime']==$data ['task_time']){
										   
										   
											if (!(strpos($time, 'PM') == false) && !(strpos($time1, 'AM') == false)) {
											...
											$next_date = date('Y-m-d', strtotime($taskstarttime .' +1 day'));

											$taskDate1=$next_date.' '.$data['original_task_time'];
					...
					, original_task_time = '" . $this->db->escape ( $data ['original_task_time'] ) . "'
					...
					, bed_check_facilities_ids = '" . $this->db->escape ( $data ['bed_check_facilities_ids'] ) . "'
					...
					, form_task_creation = '" . $this->db->escape ( $data ['form_task_creation'] ) . "'
					, required_assign = '" . $this->db->escape ( $data ['required_assign'] ) . "'
					, bedcheck_occupancy = '" . $this->db->escape ( $data ['bedcheck_occupancy'] ) . "'
	...
	public function getallTaskLists($data = array()) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,send_sms,send_email,is_approval_required_forms_id,bed_check_location_ids,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE taskadded = '0' and enable_requires_approval !=1 ";
		...
		if ($data ['facilities_id'] != "" && $data ['facilities_id'] != null) {
			$this->load->model ( 'facilities/facilities' );
			$resulsst = $this->model_facilities_facilities->getfacilities ( $data ['facilities_id'] );
			if ($resulsst ['task_facilities_ids'] != null && $resulsst ['task_facilities_ids'] != "") {
				$ddss [] = $resulsst ['task_facilities_ids'];
...
<table class="body-wrap" bgcolor="" style="width: 100%;    border-spacing: 0;">
	...
	public function getrecentTaskdetails($data = array()) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,complete_status,is_approval_required_tags_id,bed_check_location_ids,bed_check_facilities_ids,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count FROM `" . DB_PREFIX . "createtask` WHERE emp_tag_id = '" . $data ['emp_tag_id'] . "' and facilityId = '" . $data ['facilities_id'] . "' ";
	...
	public function getalltaskbyid($tags_id) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count from `" . DB_PREFIX . "createtask` WHERE 1 = 1 ";
		$sql .= " and ( emp_tag_id = '" . $tags_id . "' or medication_tags = '" . $tags_id . "' or visitation_tag_id = '" . $tags_id . "' or FIND_IN_SET('" . $tags_id . "', transport_tags) ) ";
		$query = $this->db->query ( $sql );
		return $query->rows;
	}
	...
	public function getApprovaltasklist($task_id) {
		$sql = "SELECT id,facilityId,task_date,task_time,date_added,tasktype,description,assign_to,recurrence,end_recurrence_date,recurnce_hrly,recurnce_week,recurnce_month,recurnce_day,taskadded,endtime,task_alert,alert_type_none,alert_type_sms,alert_type_notification,alert_type_email,checklist,snooze_time,snooze_dismiss,rules_task,task_form_id,tags_id,pickup_locations_address,pickup_locations_time,pickup_locations_latitude,pickup_locations_longitude,dropoff_locations_address,dropoff_locations_time,dropoff_locations_latitude,dropoff_locations_longitude,transport_tags,locations_id,task_complettion,customs_forms_id,emp_tag_id,medication_tags,completion_alert,completion_alert_type_sms,completion_alert_type_email,user_roles,userids,recurnce_hrly_perpetual,due_date_time,task_status,task_completed,recurnce_hrly_recurnce,completed_times,completed_alert,completed_late_alert,incomplete_alert,deleted_alert,end_perpetual_task,is_transport,parent_id,is_send_reminder,attachement_form,tasktype_form_id,tagstatus_id,task_group_by,end_task,formrules_id,task_random_id,form_due_date,form_due_date_after,recurnce_m,enable_requires_approval,approval_taskid,iswaypoint,original_task_time,device_id,is_approval_required_forms_id,bed_check_location_ids ,bed_check_facilities_ids,complete_status,is_create_task,unique_id,customer_key,required_approval,linked_id,formreturn_id,target_facilities_id,pause_date,pause_time,is_pause,user_role_assign_ids,assign_to_type,reminder_alert,send_notification,task_action,form_task_creation,bedcheck_occupancy,required_assign,task_count from `" . DB_PREFIX . "createtask` WHERE 1 = 1 ";

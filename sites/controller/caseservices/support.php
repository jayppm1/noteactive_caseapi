...
class Controllercaseservicessupport extends Controller { 
	...
	public function index() {
		...
		if($json['warning'] == null && $json['warning'] == ""){
			$this->load->model('notes/support');
				...
				$sdata['phone_device_id'] = $this->request->post['phone_device_id'];
				$sdata['device_unique_id'] = $this->request->post['device_unique_id'];
						
				if($this->request->post['is_android'] != null && $this->request->post['is_android'] != ""){
					$sdata['is_android'] = $this->request->post['is_android'];
				}else{
					$sdata['is_android'] = '1';
				}
				...
				$message33  .= "Facility: ".$this->request->post['facility'] . "<br>";

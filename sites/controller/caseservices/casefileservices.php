...
class Controllercaseservicescasefileservices extends Controller {
	...
	public function jsonallcaselist(){
		try {
			
			
				
			
			echo '<pre>'; print_r($this->data['casetype_data']); echo '</pre>';
		...
		try {
			...
			if ($json ['warning'] == null && $json ['warning'] == "") {
				...
				if ($this->request->post ['notes_id'] != null && $this->request->post ['notes_id'] != "") {
					...
					if ($forms_id) {
						$slq12pp = "UPDATE " . DB_PREFIX . "notes_media SET forms_id = '" . $forms_id . "', case_number='" .$this->request->post ['case_number']. "', notes_id = '" . $this->request->post ['notes_id'] . "' where notes_media_id = '" . $notes_media_id . "'";
					...
					if ($this->request->post ['upload_file'] != null && $this->request->post ['upload_file'] != "") {
						...
						$slq12pp = "UPDATE " . DB_PREFIX . "notes_media SET forms_id = '" . $forms_id . "', case_number='" .$this->request->post ['case_number']. "', notes_id = '" . $notes_id . "' where notes_media_id = '" . $notes_media_id . "'";
						$this->db->query ( $slq12pp );
					}
					...
					if ($forms_id) {
						...
						$slq12pp = "UPDATE " . DB_PREFIX . "forms SET parent_id = '" . $notes_id . "', is_case='1', case_number = '" . $this->db->escape($this->request->post ['case_number']) . "', image_url = '" . $this->db->escape($this->request->post ['upload_file']) . "' , image_name = '" . $this->db->escape($this->request->post ['file_name']) . "' where forms_id = '" . $formreturn_id . "'";
						$this->db->query ( $slq12pp );
					...
					if ($this->request->post ['upload_file'] != null && $this->request->post ['upload_file'] != "") {
						...
						$slq12pp = "UPDATE " . DB_PREFIX . "notes_media SET forms_id = '" . $forms_id . "', notes_id='".$notes_id."', case_number='" .$this->request->post ['case_number']. "' where notes_media_id = '" . $notes_media_id . "'";
						$this->db->query ( $slq12pp );
					}

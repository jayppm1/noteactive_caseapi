...
*/
	...
	$html .='<style>
		...
		$html.='<tr>  
					<td style="padding:20px;text-align:center;width:20%;" ><img src="image/printform/hc-logo-horizontal-RGB.png" width="50" height="50"> </td>
	...
	protected function getForm() {
		...
		if($this->request->get['forms_id'] == "" && $this->request->get['forms_id'] == NULL){
				...
				//var_dump($this->data['archive_url']);
			...
			if($this->request->get['forms_design_id'] == '12' ){
				//$this->data['print_url'] = $this->url->link('form/form/printintakeform', $url2, true);
				$this->data['print_url'] = $this->url->link('form/form/printform', $url2, true);
			}
		}
				...
				if($field['type'] == "select"){ 
					...
					if($field['type'] == "facility"){ 
						...
						$html .= '<option value="">Select</option>';
									...
									if($form_facilities_id == $facilitiey['facilities_id'] ){ 
						$html .= '<option value="'.$facilitiey['facilities_id'].'" selected="selected" >'.$facilitiey['facility'].'</option>';
								 }else{ 
						$html .= '<option value="'.$facilitiey['facilities_id'].'"  >'.$facilitiey['facility'].'</option>';
									 } 
									 } 
						$html .= '</select>';

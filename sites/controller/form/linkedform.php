<?php
class Controllerformlinkedform extends Controller {
	private $error = array();
	...
	protected function getForm() {
		...
		$this->data['action'] = $this->url->link('form/linkedform', $url2, true);
		$this->data['newfrm'] = str_replace('&amp;', '&',$this->url->link('form/form', $url2, true));

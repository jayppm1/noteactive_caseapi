		...
		try {
			...
			if ($json ['warning'] == null && $json ['warning'] == "") {
				...
				if ($this->request->post ['task_id'] != Null && $this->request->post ['task_id'] != "") {
					...
					$notes_id = $this->model_createtask_createtask->insertDatadetails ( $result, $data, $facilities_id, $this->request->post ['requires_approval'] );
					...
					$this->model_createtask_createtask->deteteTask ($this->request->post ['task_id'] );
		...
		try {
			...
			if ($json ['warning'] == null && $json ['warning'] == "") {
				...
				if ($tasktype_info ['enable_location'] == '1') {
					...
					$tdata4 ['facilities_id'] = $facilities_id;

<?php
class Controllercaseservicesnoteform extends Controller {
private $error = array();
		...
		if (($this->request->post['form_submit'] == '1') && $this->validateForm2()) {
			...
			if($this->request->get['notes_id'] != null && $this->request->get['notes_id'] != ""){
				//$this->session->data['ssincedentform'] = $this->request->post['ssincedentform'];
					...
					$result  = $dynamodb->putItem([
						...
						'Item' => [
						   ...
						   'date_added'    => ['S'      => empty($date_added) ? '&nbsp;': $date_added ],
							...
							'form_signature'    => ['S'      => empty($this->request->post['ssincedentform']['form_signature']) ? '&nbsp;': $this->request->post['ssincedentform']['form_signature'] ]
						]
					...
					$fsql = "INSERT INTO `" . DB_PREFIX . "forms` SET notes_id = '0', form_type = '1', form_description = '" . $form_description . "', notes_type = '" . $this->request->post['notes_type'] . "', user_id = '" . $this->request->post['user_id'] . "', signature = '" . $this->request->post['imgOutput'] . "', notes_pin = '" . $this->request->post['notes_pin'] . "', form_date_added = '" . $noteDate . "', date_added = '" . $noteDate . "', incident_number = '" . $this->request->post['ssincedentform']['incident_number'] . "', form_signature = '" . $this->request->post['ssincedentform']['form_signature'] . "', facilities_id = '" . $this->request->get['facilities_id'] . "', form_type_id = '" . $incidentform_id . "' ";
				...
				$incidentform_id = (string) $this->request->get['incidentform_id'];
					...
					$response = $dynamodb->getItem([ 
						...
						if( $this->request->post['task_form'] == '1'){
							...
							$this->model_notes_notes->updatenotessignature($response['Item']['notes_id']['N'], $this->request->post, $update_date);
							...
							$update_date = date('Y-m-d H:i:s', strtotime('now'));
							$this->model_createtask_createtask->updateForm($response['Item']['notes_id']['N'], $checklist_status, $ttstatus, $update_date);
					...
					$result  = $dynamodb->putItem([
						...
						'Item' => [
							...
							'form_signature'    => ['S'      => $response['Item']['form_signature']['S'] ]
					...
					$this->load->model('notes/notes');
					$noteDetails = $this->model_notes_notes->getnotes($this->request->get['notes_id']);
					$date_added1 = $noteDetails['date_added']; 
					
					if( $this->request->post['task_form'] == '1'){
						 $fsql = "UPDATE `" . DB_PREFIX . "forms` SET notes_id = '" . $this->request->get['notes_id'] . "', form_type = '1', form_description = '" . $form_description . "', user_id = '', notes_type = '', signature = '', notes_pin = '', date_added = '" . $date_added1 . "', form_date_added = '" . $form_date_added . "', incident_number = '" . $response['Item']['incident_number']['S'] . "', form_signature = '" . $response['Item']['form_signature']['S'] . "', facilities_id = '" . $this->request->get['facilities_id'] . "' WHERE form_type_id = '" . $incidentform_id . "' ";
		
						$this->db->query($fsql);
						
					}else{
					 $fsql = "UPDATE `" . DB_PREFIX . "forms` SET notes_id = '" . $this->request->get['notes_id'] . "', form_type = '1', form_description = '" . $form_description . "', user_id = '" . $this->request->post['user_id'] . "', notes_type = '" . $this->request->post['notes_type'] . "', signature = '" . $this->request->post['signature'] . "', notes_pin = '" . $this->request->post['notes_pin'] . "', form_date_added = '" . $form_date_added . "', date_added = '" . $date_added1 . "', incident_number = '" . $response['Item']['incident_number']['S'] . "', form_signature = '" . $response['Item']['form_signature']['S'] . "', facilities_id = '" . $this->request->get['facilities_id'] . "' WHERE form_type_id = '" . $incidentform_id . "' ";
					...
					$sql1 = "UPDATE `" . DB_PREFIX . "notes` SET update_date = '" . $update_date2 . "', notes_conut='0' WHERE notes_id = '" . (int)$this->request->get['notes_id'] . "' ";
					...
					if($this->request->post['emp_tag_id'] != null && $this->request->post['emp_tag_id'] != ""){
						...
						$this->model_notes_notes->updateNotesTag($this->request->post['emp_tag_id'], $this->request->get['notes_id'],$this->request->post['tags_id'], $update_date);
					}
	...
	public function checklistform(){
		...
		if (($this->request->post['form_submit'] == '1') && $this->validateForm3checlist()) {
			...
			//var_dump($result);
				...
				$fsql = "INSERT INTO `" . DB_PREFIX . "forms` SET notes_id = '" . $notesId . "',form_type_id = '" . $checklist_id . "', form_type = '2', form_description = '" . $form_description2 . "', user_id = '" . $this->request->post['user_id'] . "', notes_type = '" . $this->request->post['notes_type'] . "', signature = '" . $this->request->post['imgOutput'] . "', notes_pin = '" . $this->request->post['notes_pin'] . "', form_date_added = '" . $noteDate . "', date_added = '" . $date_added . "', incident_number = '', facilities_id = '" . $facilities_id . "' ";
	...
	//	var_dump($this->data['redirect_url']); die;
			...
			$this->template = $this->config->get('config_template') . '/template/notes/checklist_form.php';
			$this->response->setOutput($this->render());
		...
		if($json['warning'] == null && $json['warning'] == ""){
				...
				*/
				...
				if($response['Item']['notes_id']['S'] !=null && $response['Item']['notes_id']['S'] !=""){
					...
					$update_date = date('Y-m-d H:i:s', strtotime('now'));
					$this->model_createtask_createtask->updateForm($response['Item']['notes_id']['S'],$response['Item']['checklist_status']['S'], $ttstatus, $update_date);
					...
					$this->model_notes_notes->updatenotessignature($response['Item']['notes_id']['S'], $this->request->post, $update_date);
			...
			*/
			...
			$fcsql = "UPDATE `" . DB_PREFIX . "forms` SET notes_id = '" . $response['Item']['notes_id']['S'] . "', form_type = '2', user_id = '', notes_type = '', signature = '', notes_pin = '', form_date_added = '" . $form_date_added . "', incident_number = '', facilities_id = '" . $this->request->get['facilities_id'] . "' WHERE form_type_id = '" . $checklist_id . "' ";
			...
			$sql1 = "UPDATE `" . DB_PREFIX . "notes` SET update_date = '" . $update_date2 . "' WHERE notes_id = '" . (int)$this->request->get['notes_id'] . "' ";
		...
		if (($this->request->post['form_submit'] == '1') && $this->validateForminsert()) {
			...
			if($this->request->get['notes_id'] != null && $this->request->get['notes_id'] != ""){
				...
				/*$this->load->model('notes/notes');
					...
					$noteDate = $noteDetails['date_added']; //date('Y-m-d H:i:s', strtotime('now'));
					$date_added = (string) $noteDate;
				*/
				require_once(DIR_APPLICATION . 'aws/getItem.php');
	...
	public function checklistsignatureForm() {
		...
		if($json['warning'] == null && $json['warning'] == ""){
			...
			$fcsql = "UPDATE `" . DB_PREFIX . "forms` SET notes_id = '" . $this->request->get['notes_id'] . "', form_type = '2', form_description = '" . $form_description2 . "', user_id = '" . $this->request->post['user_id'] . "', notes_type = '" . $this->request->post['notes_type'] . "', signature = '" . $this->request->post['signature'] . "', notes_pin = '" . $this->request->post['notes_pin'] . "', date_added = '" . $date_added1 . "', form_date_added = '" . $noteDate . "', incident_number = '', facilities_id = '" . $facilities_id . "' WHERE form_type_id = '" . $checklist_id . "' ";
	...
	public function taskforminsert(){
		...
		if (($this->request->post['form_submit'] == '1') && $this->validateForm2()) {
					...
					$fsql = "INSERT INTO `" . DB_PREFIX . "forms` SET notes_id = '0', form_type = '1', form_description = '" . $form_description . "', user_id = '" . $this->request->post['user_id'] . "', notes_type = '" . $this->request->post['notes_type'] . "', signature = '" . $this->request->post['imgOutput'] . "', notes_pin = '" . $this->request->post['notes_pin'] . "', form_date_added = '" . $noteDate . "', date_added = '" . $noteDate . "', incident_number = '" . $this->request->post['ssincedentform']['incident_number'] . "', form_signature = '" . $this->request->post['ssincedentform']['form_signature'] . "', facilities_id = '" . $this->request->get['facilities_id'] . "', form_type_id = '" . $incidentform_id . "' ";

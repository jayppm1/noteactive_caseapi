...
class Controllercommonheadertask extends Controller
{
    ...
    protected function index ()
    {
        try {
            ...
            $this->document->setTitle('Task List');
            $this->data['heading_title'] = 'Task List';
            ...
            $this->template = $this->config->get('config_template') . '/template/common/headertask.php';
            ...
            $activity_data2 = array(
                    'data' => 'Error in Sites Common headertask'
            );
            $this->model_activity_activity->addActivity('sitesheadertask', $activity_data2);
        }
    }
}
?>

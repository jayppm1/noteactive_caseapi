									...
									//if($dailytime == $rules_operation_time){
										...
										$onschedule_description = nl2br($onschedule_rules_module['onschedule_description']);
											...
											if($onschedule_rules_module['onschedule_action'] == '2'){
												...
												$resultd['notetime'] = date('h:i A', strtotime($rule['rules_operation_time']));
									...
									if($currentDay == $recurnce_week){
										...
										//if($dailytime == $rules_operation_time){
											...
											if($onschedule_rules_module['onschedule_action'] == '2'){
												...
												$resultw['notetime'] = date('h:i A', strtotime($rule['rules_operation_time']));
									...
									if($currentdate == $recurnce_day_date){
										...
										//if($dailytime == $rules_operation_time){
											...
											if($onschedule_rules_module['onschedule_action'] == '2'){
												...
												$resultm['notetime'] = date('h:i A', strtotime($rule['rules_operation_time']));
...
return $html;
	...
	public function notification() {
										...
										if($onschedule_rules_module['onschedule_action'] == '4'){
											...
											$sqls23d = "SELECT * FROM `" . DB_PREFIX . "createtask` where rules_task = '".$onschedule_rules_module['task_random_id']."' ";
												...
												if($query4d->num_rows == 0){
													...
													$this->load->model('createtask/createtask');
													$this->model_createtask_createtask->addcreatetask($addtaskd, $this->customer->getId());
												}	
										}
									}
										...
										if($dailytime == $rules_operation_time){
											...
											if($onschedule_rules_module['onschedule_action'] == '4'){
												...
												if($query4w->num_rows == 0){
													...
													$this->load->model('createtask/createtask');
													$this->model_createtask_createtask->addcreatetask($addtaskw, $this->customer->getId());
										...
										if($dailytime == $rules_operation_time){
											...
											if($onschedule_rules_module['onschedule_action'] == '4'){
												...
												if($query4m->num_rows == 0){
													...
													$this->load->model('createtask/createtask');
													$this->model_createtask_createtask->addcreatetask($addtaskm, $this->customer->getId());
												}
											}
		...
		$datasms1['top'] = '1';
		//$datasms1['send_sms'] = '1';
		$datasms1['facilities_id'] = $this->customer->getId();
		...
		$dataemail1['facilities_id'] = $this->customer->getId();

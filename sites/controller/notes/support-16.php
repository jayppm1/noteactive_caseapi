			...
			$this->load->model('notes/notes');
			 ...
			 require_once(DIR_SYSTEM . 'library/twilio-php-master/smsconfig.php');
				...
				if($support_infobynumber){
					...
					if($notes_description != 'Yes' && $notes_description != 'No'){
						$fresult_info = array();
						$fresult_info['questions'] = $notes_description;
					...
					if($notes_description == 'Yes'){
							...
							$_SESSION['support_confirmation_1'] = $notes_description;
					...
					//var_dump($_SESSION['support_confirmation_1']);
					
					if($_SESSION['support_id'] != '' && $_SESSION['support_id'] != null){
						
						if($_SESSION['support_confirmation_1'] == 'Yes'){
					...
					if($_SESSION['support_id'] != '' && $_SESSION['support_id'] != null){
						...
						if($_SESSION['support_confirmation'] == null && $_SESSION['support_confirmation'] == ""){
							...
							if($notes_description == 'No'){
								...
								$smstext = 'Please send us your email id, we will be sending details regarding your query.'; 
								$number = '+'.$from;
								$from = "+".$to;
								$response = $client->messages->create(
									$number,

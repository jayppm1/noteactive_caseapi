...
class ControllerCaseSearchresult extends Controller
{
            ...
            foreach ($years as $year) {
                ...
                foreach ($months as $month) {
                    ...
                    $data = array(
                            ...
                            'activenote_incident' => '44',
                            // 'keyword' => 'incident',
                            // 'search_acitvenote_with_keyword' => '1',
                            
                            'activenote_medication' => '38',
                            // 'keyword' => 'medication',
                            // 'search_acitvenote_with_keyword' => '1',
                    ...
                    $count_notes_activity = $this->model_resident_dashboard->getTotalnotess($data);
                    
                    // var_dump($count_notes_activity);
                    // echo "<hr>";
                    ...
                    if ($count_notes_activity['total_notes'] > 0) {
                        $notemonths[] = array(
                                ...
                                'ttotaltasks' => $count_notes_activity['total_task'],
                                ...
                                'incidentcount' => $count_notes_activity['total_incident'],
                                'sightandsoundcount' => $count_notes_activity['total_sightandsound'],
                                
                                'highlightercount' => $count_notes_activity['total_highlighter'],
                                'activenotecount' => $count_notes_activity['total_activenote'],
                                'colorcount' => $count_notes_activity['total_color'],
                                'reviewcount' => $count_notes_activity['total_review'],
                                
                                'pillcallcount' => $count_notes_activity['total_medication'],
    ...
    public function report ()
    {
        ...
        $this->data['tagassignotes'] = $this->model_notes_notes->gettagassigns($this->customer->getUId());
        ...
        if (isset($this->session->data['search_emp_tag_id'])) {
        ...
        $last_notesID = $this->model_notes_notes->getLastNotesID($this->customer->getUId(), $searchdate);
        ...
        $facilityinfo = $this->model_facilities_facilities->getfacilities($this->customer->getUId());

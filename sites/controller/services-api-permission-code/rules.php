			...
			foreach($complteteTaskLists as $list){
				if($tthestime >= $list['snooze_time']){
					...
					if($list['checklist'] == "incident_form"){
						...
						$insert_href = str_replace('&amp;', '&', $this->url->link('services/form', '' . 'forms_design_id=' . $list['checklist']. '&task_id=' . $list['id']. '&facilities_id=' . $list['facilityId']));
						$attachement_form = '1';
					}elseif($list['attachement_form'] == '1'){
						$insert_href = str_replace('&amp;', '&', $this->url->link('services/form', '' . 'forms_design_id=' . $list['tasktype_form_id']. '&task_id=' . $list['id']. '&facilities_id=' . $list['facilityId']));

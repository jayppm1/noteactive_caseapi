...
class Controllerservicesapptask extends Controller {
	...
	public function jsonTasktype(){
		...
		$results = $this->model_createtask_createtask->getTaskdetails();
		...
		$this->response->setOutput(json_encode($value));
				...
				$activity_data2 = array(
					'data' => 'Error in apptask jsonTasktype',
				);
	...
	public function jsonInterval(){
		...
		$this->load->model('createtask/createtask');
		$results = $this->model_createtask_createtask->getTaskintervals();
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonInterval',
				);
		...
		if($this->request->post['facilities_id'] != null && $this->request->post['facilities_id'] != ""){
			...
			if($facilities_info['config_task_status'] == '1'){
				...
				foreach($tasktypes as $tasktype){
					...
					$taskTotal1 = $this->model_createtask_createtask->getCountTasklist($facilities_id, $currentdate, $top, $this->request->post['facilities_timezone'], $this->request->get['tags_id'], $tasktype['task_id']);	
					
					$taskTotal = $taskTotal + $taskTotal1;
					
				}
				
				date_default_timezone_set($this->request->post['facilities_timezone']);
				...
				foreach($listtasks as $list){					
					...
					$tasktype_info = $this->model_createtask_createtask->gettasktyperowByName($list['tasktype']);
			...
			$value = array('results'=>$this->data['listtask'],'Tasktotal'=>$taskTotal,'status'=>true);
			/*echo json_encode($value);*/
			$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonTasklist',
				);
	...
	public function jsonAddTasknote(){
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonAddTasknote',
				);
	...
	public function jsonUpdateStriketask(){
	 try{
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonUpdateStriketask',
				);
	...
	try{		
		...
		if($json['warning'] == null && $json['warning'] == ""){
			$data = array();
			   ...
			   $notes_id = $this->model_createtask_createtask->inserttask($result, $data, $this->request->post['facilities_id'],$this->request->post['requires_approval']);
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonSavetask',
				);
	...
	public function jsonTaskData(){
		...
		$this->load->model('createtask/createtask');
		$intervals = $this->model_createtask_createtask->getTaskintervals();
		...
		$this->load->model('user/user_group');
			$user_infos = $this->model_user_user_group->getUserGroups($this->request->post['filter_name']);
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonTaskData',
				);
	...
	public function getNotification(){
		...
		if($api_header_value == false){
			...
			if($facilities_info['config_task_status'] == '1'){
				...
				$value = array('results'=>$this->data['listtask'],'status'=>$error);
				/*echo json_encode($value);*/
				$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask getNotification',
				);
	...
	public function getNotificationWear(){
		...
		if($api_header_value == false){
			...
			if($facilities_info['config_task_status'] == '1'){
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask getNotificationWear',
				);
	...
	public function jsongetTaskdetail(){
		...
		if($this->request->post['task_id'] != null && $this->request->post['task_id'] != ""){
						...
						foreach($formDatas as $formData){
							...
							*/
							...
							if($customlistvalues_tags){
								foreach($customlistvalues_tags as $customlistvalues_tag){
									$custom_tags[] = array(
										'tags_id' => $customlistvalues_tag['tags_id'],
										'emp_tag_id' => $customlistvalues_tag['emp_tag_id'],
										'emp_first_name' => $customlistvalues_tag['emp_first_name'],
										'emp_last_name'  => $customlistvalues_tag['emp_last_name'],
										'upload_file'  => $customlistvalues_tag['upload_file'],
									);
								}
							}
			...
			$value = array('results'=>$this->data['listtask'],'status'=>$trstatus);
			/*echo json_encode($value);*/
			$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsongetTaskdetail',
				);
	...
	public function jsonSavetaskBy2(){
		...
		if($json['warning'] == null && $json['warning'] == ""){
				...
				*/
			    ...
			    $notes_id = $this->model_createtask_createtask->inserttask($result, $data, $this->request->post['facilities_id']);
				...
				if($tasklocations != null && $tasklocations != ""){
					foreach($tasklocations as $tasklocation){
						...
						$task_content .= ' | Check at '. $tasklocation['task_time'].' By '. $this->request->post['user_id'];
						...
						$tdata1['facilities_id'] = $this->request->post['facilities_id'];
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonSavetaskBy2',
				);
		...
		if($json['warning'] == null && $json['warning'] == ""){
				...
				*/
				...
				if($this->request->post['emp_tag_id'] != null && $this->request->post['emp_tag_id'] != ""){
				 ...
				 $this->model_notes_notes->updateNotesTag($this->request->post['emp_tag_id'], $notes_id, $this->request->post['tag_id'], $update_date);
				}
	...
	public function jsongetcustomelist(){
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsongetcustomelist',
				);
	...
	public function jsonaddcoordinates(){
		try{
			...
			$this->load->model('activity/activity');
			$activity_data2 = array(
				'data' => 'Error in jsonaddcoordinatest',
			);
	...
	public function jsongetcoordinates(){
		...
		$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsongetcoordinates',
				);
	...
	public function jsonapprovalTasklist(){
		...
		if($this->request->post['facilities_id'] != null && $this->request->post['facilities_id'] != ""){
			...
			$value = array('results'=>$this->data['listtask'],'status'=>true);
			/*echo json_encode($value);*/
			$this->response->setOutput(json_encode($value));
				...
				$this->load->model('activity/activity');
				$activity_data2 = array(
					'data' => 'Error in apptask jsonapprovalTasklist',
				);
